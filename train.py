...
커맨드 예시
python train.py --model_type=yolo3_mobilenet_lite --anchors_path=configs/tiny_yolo3_anchors.txt --annotation_file=trainval_misaeng.txt --classes_path=configs/misaeng_classes.txt --eval_online --save_eval_checkpoint
...
if __name__ == '__main__':
    ...
    # Data options
    parser.add_argument('--annotation_file', type=str, required=False, default='trainval_misaeng.txt',
    ...
    parser.add_argument('--transfer_epoch', type=int, required=False, default=30,
